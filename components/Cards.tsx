    ...
    return (
        <TouchableOpacity onPress={onPress} className='w-60 h-80 flex flex-col items-start relative'>
            ...
            <View className='flex flex-row items-center bg-white/90 px-3 py-1.5 rounded-full absolute top-5 right-5'>
                ...
                <Text className='text-sm font-bold text-primary-300 ml-1'>4.4</Text>
            </View>
            ...
            <View className='flex flex-col items-start absolute bottom-5 inset-x-5'>
                ...
                <Text className='text-base text-white'>
                    22 Wole Ariyo St, Ilupeju, Lagos
                </Text>
    ...
    return (
        ...
        shadow-black-100/70 relative'>
            <View className='flex flex-row items-center absolute px-2 top-5 right-5 bg-white/90 p-1 rounded-full z-50'>
                ...
                <Text className='text-sm font-bold text-primary-300 ml-0.5'>4.4</Text>
            </View>
